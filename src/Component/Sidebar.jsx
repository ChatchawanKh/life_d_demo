            ...
            <div className="sidebar-list1">
                ...
                <div className="list">
                    <ul className="listContainer">
                        <li className='active'>
                            <img src={Home} alt='icon' className='Home' style={{ width: '30px', marginLeft: 'auto', verticalAlign: 'middle', alignContent: 'center' }}
                            ></img>
                            <a href='#'>
                                หน้าแรก
                            </a>
                        ...
                        <li className='active'>
                            <img src={Mask} alt='icon' className='Mask' style={{ width: '30px', marginLeft: 'auto', verticalAlign: 'middle', alignContent: 'center' }}
                            ></img>
                            <a href='#'>
                                โรคระบบทางเดินหายใจ
                            </a>
                        ...
                        <li className='active'>
                            <img src={Sun} alt='icon' className='Sun' style={{ width: '30px', marginLeft: 'auto', verticalAlign: 'middle', alignContent: 'center' }}
                            ></img>
                            <a href='#'>
                                โรคฮีทสโตรก
                            </a>
                        ...
                        <li className='active'>
                            <img src={Mosquito} alt='icon' className='Mosquito' style={{ width: '30px', marginLeft: 'auto', verticalAlign: 'middle', alignContent: 'center' }}
                            ></img>
                            <a href='#'>
                                โรคไข้เลือดออก
                            </a>
